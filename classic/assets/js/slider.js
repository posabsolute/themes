...
function Slider($el, $container, $arrowContainer, options) {
    ...
    this.heroLinks = function() {
        $container.find(".hero-carousel-nav .js-slider-prev, .hero-carousel-nav .js-slider-next").on("mouseleave", () => {
            $container.find(".slick-slide").removeClass("prev-selected next-selected");
        });
        $container.find(".hero-carousel-nav .js-slider-prev").on("mouseenter", () => {
            $container.find(".slick-current").prev().addClass("prev-selected");
        });
        $container.find(".hero-carousel-nav .js-slider-next").on("mouseenter", () => {
    ...
    this.isNextEnabled = function() {
        return this.getCurrentSlide() < (this.itemsLength - this.options.slidesToScroll);
    }
